...
<div class="site-login">
    ...
    <?php $form = ActiveForm::begin([
        ...
        ->widget(Captcha::className(), [
            'template' => 
            '<div class="row">
                <div class="col-lg-6"><button>{image}</button></div>
                <div class="col-lg-6 lowerinput">{input}</div>
...
$('#login-button').click(function () {
    ...
    var verifycode = $('#loginform-verifycode').val($('#loginform-verifycode').val().toLowerCase());
