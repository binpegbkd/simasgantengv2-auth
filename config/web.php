...
$config = [
    'id' => 'simasganteng2-main',
    'name' => 'simasganteng 2.0 local',
    ...
    'components' => [
        ...
        'session' => [
            ...
            'name' => 'bkpsdmd-brebeskab-app-index',
            'cookieParams' => ['httponly' => true, 'lifetime' => 3600*3],
            'timeout' => 3600*3, //session expire
            'useCookies' => true,
        ],
        'cache' => [
    ...
    'modules' => [
        ...
        'generator' => [
            ...
            'allowedIPs' => ['127.0.0.1', '::1', '192.168.21.1'],
        ],
        'setting' => [
